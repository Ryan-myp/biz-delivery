---
title: Meta Conversions API (CAPI) 生产级指南：事件匹配、去重与批量落地的深度实践
created: 
updated: 2026-06-09
type: entity
tags: [access_token, manage, pixel_id, event_name, ViewContent, Search, AddToCart, AddToWishlist, InitiateCheckout, AddPaymentInfo]
---
