---
title: MySQL InnoDB 存储引擎源码级深度分析
created: 
updated: 2026-06-09
type: concept
tags: [7-mvcc多版本并发控制, 6-undo-log实现, 5-redo-log实现, 9生产调优实践, 4-doublewrite-buffer, 2-buffer-pool设计, 8锁机制, 3-change-buffer机制, 1-innodb架构总览]
---
